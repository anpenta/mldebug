...
class NumericRangeAnomalyCheck:
    ...
    This check compares current data against the minimum and maximum values observed in
    the reference data. An issue is reported when one or more values fall outside this
    range.
